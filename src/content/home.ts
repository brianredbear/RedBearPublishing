export const homeContent = {
  title: "Redbear Publishing - Redbear Publishing",
  description:
    "Redbear Publishing is a place of fantastical worlds, intriguing characters, and page-turning stories. Pull up a chair, get cozy and start reading!",
  welcome: "Welcome to Redbear Publishing.",
  intro:
    "Redbear Publishing is a place of fantastical worlds, intriguing characters, and page-turning stories. Pull up a chair, get cozy and start reading!",
  book2Heading: "Book 2 of The Softwire series is out!",
  book2: {
    title: "Betrayal on Orbis 2",
    subtitle: "Book 2: The Softwire Series",
    description:
  ...
  book1: {
    ...
    subtitle: "Book 1: The Softwire Series",
    description:
    ...
    forewordHtml: "Foreword by <strong>Nathan Fillion</strong>",
    amazon: "https://amzn.to/3flV3Ql",
  ...
  ogImage: "Softwire_-Betrayal-on-Orbis-2-web.jpg",
  author: "PJ Haarsma",
};
